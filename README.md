...
A Minecraft mod that gives Golems their time in the spotlight once again.

## Curseforge

https://www.curseforge.com/minecraft/mc-mods/golemancy-artifice
...
dependencies {
    ...
    implementation "com.klikli_dev:golemancy-artifice-${minecraft_version}-neoforge:${golemancy_artifice_version}"
